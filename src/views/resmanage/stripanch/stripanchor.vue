  ...
  <div class="app-container">
    <div class="block">
      ...
      <el-row :gutter="20">
        ...
        <el-col v-if="actvieGroup === 'realanchor'" :span="4">
        ...
        <el-col :span="6" style="margin-left: 60px;">
          <el-button v-if="actvieGroup === 'realanchor'" size="mini" style="background-color: #262626;color: #FFFFFF;" @click.native="add">添加主播</el-button>
          <el-button v-else size="mini" style="background-color: #262626;color: #FFFFFF;" @click.native="add">添加机器人</el-button>
        </el-col>
      </el-row>
    </div>
    <el-table
    ...
    >
      ...
      <el-table-column label="操作">
        <el-row slot-scope="scope" :span="6">
          <el-button v-if="actvieGroup === 'realanchor'" type="text" size="mini" @click.native="goToDetail(scope.row.id)">查看</el-button>
          <el-button v-else type="text" size="mini" @click.native="goToRobotDetail(scope.row.id)">查看</el-button>
          <el-button v-if="2 === scope.row.configtype" type="text" size="mini" @click.native="removeMainUser(scope.row)">移除</el-button>
        </el-row>
      </el-table-column>
    </el-table>
      ...
      <el-form ref="form" :model="form" :rules="rules">
        <el-row :gutter="20" style="margin-left: 50px;">
          ...
          <el-col :span="3" style="margin-left: 160px;">
            <el-button v-if="actvieGroup === 'realanchor'" size="mini" style="background-color: #262626;color: #FFFFFF;" @click.native="fetchQueryData(form.id)">{{ $t('button.search') }}</el-button>
            <el-button v-else size="mini" style="background-color: #262626;color: #FFFFFF;" @click.native="fetchQueryData2(form.id)">{{ $t('button.search') }}</el-button>
          </el-col>
        </el-row>
        <el-table
          :data="querylist"
...
<script src="./stranchor.js"></script>
